  ...
  defmacro __using__(options) do
    quote do
      ...
      if !@role_table_action_schema do
        raise "please define role_table_action_schema when using role table action agent"
      end

      if !@repo do
        raise "please define repo when using role table action agent"
      end
      ...
      # Load from database
      def seed() do
        @repo.all(@role_table_action_schema)
      end
